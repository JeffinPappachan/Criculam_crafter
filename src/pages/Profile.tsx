...
const Profile = () => {
  ...
  const [component, setComponent] = useState<"personal" | "academic">(
    "personal"
  );
  const PersonelDetails = () => {
    return (
      <form className="flex flex-col gap-3">
        ...
        />
        <input type="submit" onClick={() => setComponent("academic")} />
      </form>
    );
  };
    ...
    <div className="w-screen p-20 flex flex-col items-center justify-center">
      <Card className="p-10 w-[90%] max-w-[500px]">
        ...
        <CardContent className="flex items-center flex-col justify-center">
          {component == "personal" && <PersonelDetails />}
          {component == "academic" && <AcademicDetails />}
        </CardContent>
